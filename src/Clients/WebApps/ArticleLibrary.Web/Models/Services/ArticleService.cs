...
namespace ArticleLibrary.Web.Models.Services
{
    public class ArticleService : IArticleService
    {
        ...
        public ArticleService(IConfiguration configuration)
        {
            ...
            BaseUrl = $"{configuration["GatewayUrl"]}/article";
        }

        public async Task AddAsync(ArticleAddDTO authorAdd)
        {
        ...
        public async Task<List<ArticleDTO>> GetAllAsync()
        {
            ...
            var result = await GetRequestAsync<List<ArticleDTO>>(sendUrl);
            return result;
        }
        ...
        public async Task<ArticleDTO> GetByIdAsync(string Id)
        {
            ...
            var result = await GetRequestAsync<ArticleDTO>(sendUrl);
            return result;
        }

        public async Task UpdateAsync(ArticleUpdateDTO articleUpdate)
        {
